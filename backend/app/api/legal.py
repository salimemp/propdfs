        ...
        "data_categories": [
            {
                ...
                "description": "Email, name, profile data",
                "purpose": "Authentication and service provision",
            },
            {
                "category": "Documents",
                "description": "Uploaded and processed files",
                "purpose": "Processing your requests",
            },
            {
                "category": "Usage Data",
                "description": "Logs of actions taken",
                "purpose": "Service improvement and security",
            },
            {
                "category": "Payment Data",
                "description": "Billing information (via Stripe)",
                "purpose": "Subscription management",
            },
            {
                "category": "Device Data",
                "description": "IP, browser, device type",
...
async def cancel_deletion(
    ...
    if (
        ...
        or not current_user.deletion_scheduled_at
    ):
    ...
    logger.info(
        "deletion_cancelled", user_id=str(current_user.id), deletion_id=deletion_id
    )
