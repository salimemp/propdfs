...
class OCRService:
    ...
    SUPPORTED_LANGUAGES = {
        ...
        "jpn", "kor", "ara", "hin", "tha", "vie", "pol", "tur", "nld", "swe",
        "nor", "dan", "fin", "ces", "hun", "ron", "ukr", "heb", "ell", "ben",
    }
    ...
    def ocr_pdf(self, input_path: str, language: str = "eng", 
            ...
            for page_num in range(doc.page_count):
                ...
                for i in range(len(text_blocks['text'])):
                    if int(text_blocks['conf'][i]) > 60:
                        x, y, w, h = (text_blocks['left'][i], text_blocks['top'][i],
                                      text_blocks['width'][i], text_blocks['height'][i])
